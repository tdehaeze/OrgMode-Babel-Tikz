...
* Classical Feedback
#+begin_src latex :file classical_feedback.svg
  \begin{tikzpicture}
...
#+begin_src latex :file sf_architecture.svg
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
    \node[block, right=1 of addfb] (K){$K$};
    \node[addb={+}{}{}{}{}, right=1 of K] (adddu){};
...
#+begin_src latex :file sf_complementary_filters.svg
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
    \node[block, right=1 of addfb] (K){$K$};
...
#+begin_src latex :file sf_eq_conf.svg
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
...
* Sf Error
#+begin_src latex :file sf_error.svg
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
...
#+begin_src latex :file sf_virtual.svg
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
    \node[block, right=1 of addfb] (K){$K$};
    \node[addb={+}{}{}{}{}, right=2 of K] (adddu){};
