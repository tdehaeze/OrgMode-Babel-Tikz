...
* Classical Feedback
#+begin_src latex :file classical_feedback.svg :exports both
  \begin{tikzpicture}
...
#+RESULTS:
[[file:classical_feedback.svg]]

* Sensor Fusion Architecture
#+begin_src latex :file sf_architecture.svg :exports both
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
    \node[block, right=1 of addfb] (K){$K$};
    \node[addb={+}{}{}{}{}, right=1 of K] (adddu){};
...
#+RESULTS:
[[file:sf_architecture.svg]]

* Complementary Filters
#+begin_src latex :file sf_complementary_filters.svg :exports both
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
    \node[block, right=1 of addfb] (K){$K$};
...
#+RESULTS:
[[file:sf_complementary_filters.svg]]

* Equivalent Configuration
#+begin_src latex :file sf_eq_conf.svg :exports both
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
...
* Sf Error
#+begin_src latex :file sf_error.svg :exports both
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
...
#+begin_src latex :file sf_virtual.svg :exports both
  \begin{tikzpicture}
    \node[addb={+}{}{}{}{-}] (addfb) at (0, 0){};
    \node[block, right=1 of addfb] (K){$K$};
    \node[addb={+}{}{}{}{}, right=2 of K] (adddu){};
